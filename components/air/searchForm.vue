...
export default {
  data() {
    return {
      ...
      // 表单的校验规则,trigger是随便填的,默认是blur,主要是blur交换我们觉得不好看,想要覆盖掉这个功能
      rules: {
        departCity: [
        ...
        departDate: [
          { required: true, message: "请选中出发时间", trigger: "blur" }
        ]
      }
    };
  },
